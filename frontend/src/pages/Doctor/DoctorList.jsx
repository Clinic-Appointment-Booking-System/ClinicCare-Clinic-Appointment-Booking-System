...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#cce1ff] font-[Poppins]">
      ...
      <nav className="flex justify-between items-center bg-white border-b-2 border-blue-600 px-6 py-5 flex-wrap">
        <div className="flex flex-wrap gap-6">
          {["Dashboard", "Doctors", "Appointments", "Settings"].map(
            (item, i) => (
              <div
                key={i}
        ...
        <div className="flex items-center gap-5 mt-2 sm:mt-0">
          <MessageSquare className="text-gray-700 hover:text-blue-600 cursor-pointer" />
          <Bell className="text-gray-700 hover:text-blue-600 cursor-pointer" />
